...
U 是**自进化的核心**——没有 U，B 永远不会改变，Agent 永远是"固定的" [r-note-001](../../research/r-note-001-operational-morphology.md)。
...
MCTS 的优势是"树搜索能跳出局部最优"，适合"组件修改空间大"的情况 [r-paper-016](../../research/r-paper-016-cheng2024promptagent.md)。
...
U 本身是新的失败点。必须给 U 配 4 层安全治理 [r-note-007](../../research/r-note-007-governance-necessity.md)：
...
U 必须能**自动选择**修改策略（OPRO vs DSPy vs PromptAgent）+ **切换修改对象**（P vs T vs M vs C）+ **保证安全**（沙箱 + 回滚 + 审核）[r-note-009](../../research/r-note-009-agent-levels-formalized.md)。
...
- [r-note-001](../../research/r-note-001-operational-morphology.md) — 元控制器 U 的形式化位置
- [r-note-009](../../research/r-note-009-agent-levels-formalized.md) — 元控制能力与智能体层级
- [r-paper-016](../../research/r-paper-016-cheng2024promptagent.md) — MCTS 驱动的候选搜索
- [r-paper-008](../../research/r-paper-008-yang2023opro.md) — LLM 作为优化器的元优化范式
- [r-paper-019](../../research/r-paper-019-alphaevolve2025.md) — 候选生成、评估与选择循环
- [r-note-003](../../research/r-note-003-synergistic-evolution.md) — 跨组件协调目标
- [r-note-007](../../research/r-note-007-governance-necessity.md) — 元控制器的约束、回滚与审核
