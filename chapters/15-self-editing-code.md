...
**CodeAct** 由 Wang 等人 2024 年 2 月提出，把 Python 代码作为 Agent 的**统一动作空间** [r-paper-020](../../research/r-paper-020-codeact2024.md)。CodeAct 的核心思想是：**Agent 的每一步行动都是 Python 代码**——比"调用预定义工具"更灵活。
...
**SICA（Self-Improving Coding Agent）** 由 Robeyns 等人 2025 年 4 月提出 [r-paper-006](../../research/r-paper-006-robeyns2025sica.md)。SICA 是**首个明确"agent 编辑自己源代码"** 的工作——Agent 不只是"修改任务的代码"，而是"修改 Agent 系统自身的代码"。
...
**Gödel Agent** 由 Yin 等人 2024 年 10 月提出，是把 **Gödel 机器** 思想应用到 LLM Agent 的代表工作 [r-paper-007](../../research/r-paper-007-yin2024godelagent.md)。
...
**AlphaEvolve** 由 Google DeepMind 2025 年 5 月发布（13 章已讨论）。AlphaEvolve 把"代码库"视为"巨型可进化对象" [r-paper-019](../../research/r-paper-019-alphaevolve2025.md)。
...
- [r-paper-006](../../research/r-paper-006-robeyns2025sica.md) — SICA：智能体改写自身源代码
- [r-paper-007](../../research/r-paper-007-yin2024godelagent.md) — Gödel Agent：递归自指式自改进
- [r-paper-020](../../research/r-paper-020-codeact2024.md) — CodeAct：代码作为统一动作空间
- [r-paper-019](../../research/r-paper-019-alphaevolve2025.md) — AlphaEvolve：评估器驱动的代码库进化
- [r-paper-013](../../research/r-paper-013-jimenez2024swebench.md) — SWE-bench：真实软件工程任务评测
- [r-note-004](../../research/r-note-004-self-modifying-agent-safety.md) — 自改写代码的安全边界
- [r-note-014](../../research/r-note-014-self-modification-attack-surface.md) — 代码自修改的攻击面与逃逸风险
